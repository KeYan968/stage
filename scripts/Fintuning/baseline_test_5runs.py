...
Usage:
    python3 baseline_test_5runs.py
"""
...
OUTPUT_DIR  = "/home/kyan/stage/Datasets/Experiment_results/LLaMA 3-8B-Instruct/Baseline_results_LLaMA 3-8B-Instruc/5runs"
N_RUNS      = 5
...
for run in range(1, N_RUNS + 1):
    ...
    output_file = os.path.join(OUTPUT_DIR, f"baseline_run_{run}.json")
