"""
Fine-tuned model inference — LLaMA 3-8B-Instruct after QLoRA fine-tuning (V1, no error_type).
...
Usage:
    python3 main_sparql_test_v1_5runs.py
"""
...
OUTPUT_DIR  = "/home/kyan/stage/Datasets/Experiment_results/LLaMA 3-8B-Instruct/v1_results_LLaMA 3-8B-Instruct/5runs"
N_RUNS      = 5
...
for run in range(1, N_RUNS + 1):
    ...
    output_file = os.path.join(OUTPUT_DIR, f"v1_run_{run}.json")
